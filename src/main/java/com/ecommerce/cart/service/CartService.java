...
public class CartService {
    ...
    public CartResponse addItem(CartItemRequest request) {
        ...
        Product product = productService.getActive(request.productId());
        ...
        if (existing != null) {
            ...
            cartItemRepository.save(new CartItem(cart.getId(), product.getId(), product.getSku(), request.quantity()));
        }
        return toResponse(cart);
    }
    ...
    private CartItemResponse toItemResponse(CartItem item) {
        ...
        try {
            Product product = productService.getActive(item.getProductId());
